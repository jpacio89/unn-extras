...
//        print_r($trades);
    ...
    function getInvestors() {
        ...
        $json = file_get_contents('https://www.etoro.com/sapi/rankings/rankings/?blocked=false&bonusonly=false&client_request_id=35bd969d-650e-40a1-b082-9970109dc318&copyblock=false&istestaccount=false&lastactivitymax=30&optin=true&page=1&pagesize=300&period=OneYearAgo&sort=-gain&tradesmin=500&verified=true');
